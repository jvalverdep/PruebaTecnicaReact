...
let AppsService = class AppsService {
    ...
    async createOne(application) {
        console_1.assert(application.id === 0, 'Application id must be 0.');
        let applicationToCreate = new apps_entity_1.Application();
...
AppsService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_2.InjectRepository(apps_entity_1.Application)),
